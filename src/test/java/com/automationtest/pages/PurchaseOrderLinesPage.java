...
public class PurchaseOrderLinesPage extends WorkOrderPage {
    ...
    WebElement UnitCost;
    @FindBy(xpath = "(//input[@class='fld text   tt fld fld_req'])[3]")
    WebElement LineCost;
    ...
    public void LinkWorkOrderNumber() throws InterruptedException, IOException {
        Thread.sleep(2000);
        FileReader FR = new FileReader("C:\\Workspace\\FT-SMOKETEST-main\\WO.txt");
    ...
    public static String verifythestatusofPO() throws IOException {
        ...
        File file = new File("C:\\Workspace\\FT-SMOKETEST-main\\SmokeTest_FT_Results.txt");
        if (!file.exists()) {
            file.createNewFile();
        }
