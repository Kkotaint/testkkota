...
public class PreventiveMaintenancePage extends Testbase {
    ...
    @FindBy(xpath = "(//button[@class='text pb default'])[1]")
    WebElement OKButton;
    ...
    @FindBy(xpath = "//button[text()='New Row']")
   ...
   // @FindBy(xpath = "//img[@id='ROUTEWF__-tbb_image']")
    ...
    public void searchPM() {
       PMsearchField.sendKeys("11117" + Keys.ENTER);
    ...
    public void clickonNewRow() throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebDriverWait wait1 = new WebDriverWait(driver, 60);
        wait1.until(ExpectedConditions.elementToBeClickable(NewRowButton)).click();


    }
    public void searchFODPM() throws InterruptedException {
        Thread.sleep(2000);
        PMsearchField.sendKeys("11127*" + Keys.ENTER);
        //PMsearchField.sendKeys("10107" + Keys.ENTER);
    ...
    public void enterLabourNumber() throws InterruptedException {
        Thread.sleep(2000);
        WebDriverWait wait = new WebDriverWait(driver, 60);
        wait.until(ExpectedConditions.elementToBeClickable(LabourField)).sendKeys("418590"+Keys.ENTER+Keys.ENTER);
      //  Thread.sleep(4000);
      //  OKButton.click();
      //  Thread.sleep(4000);
