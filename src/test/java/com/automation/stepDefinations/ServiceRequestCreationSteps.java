...
public class ServiceRequestCreationSteps extends Testbase {
   ...
   /* @Then("^user fill the new Service Request form$")
    ...
    public void userClicksOnAdvanceSearch() throws InterruptedException, IOException {
        serviceRequestPage = new ServiceRequestPage();
        serviceRequestPage.ClickonAdvancedSearch();
        serviceRequestPage.enterFODNumber();
        //serviceRequestPage.FindButton();
        // FodReactivePage.enterFODNumber();
    }

    @And("^user clicks on find button$")
    public void userClicksOnFindButton() throws InterruptedException {
        serviceRequestPage = new ServiceRequestPage();
