...
public class CustomerBillingSteps extends Testbase {
    ...
    public void userVerifiedThatTheWorkorderStatusMoveToTravel() throws InterruptedException, AWTException {
        workOrderPage.clickonOKbutton();
        Thread.sleep(1000);
    }
    @Then("^user verified that the workorder status move to 'WaitingInSchedule'$")
    public void userVerifiedThatTheWorkorderStatusMoveToWaitingInSchedule() throws InterruptedException, AWTException {
        workOrderPage = new WorkOrderPage();
        workOrderPage.clickonOKbutton();
    }

    @Then("^user verified that the workorder status move to 'Start'$")
    public void userVerifiedThatTheWorkorderStatusMoveToStart() throws InterruptedException, AWTException {
        workOrderPage.clickonOKbutton();
    }
    ...
    @Then("^user go to 'Customer Billing' page and search for Bill Batch$")
    ...
    public void userApproveTheBillBatch() throws InterruptedException, AWTException {
        workOrderPage = new WorkOrderPage();
    ...
    public void userVerifiesThatTheBillBatchStatusChangesToPosted() throws InterruptedException, AWTException {
        homePage = new HomePage();
        homePage.searchforCustomerBilling();
        customerBillingPage.enterBillBatchNumber(BillBatchNO);
        customerBillingPage.clickonBillBatchLink();
